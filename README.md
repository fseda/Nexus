...
**Descrição:**  
O usuário irá poder buscar (em uma barra de busca) por algo específico (que esteja presente no sistema).
...
1. Usuário acessa a barra de busca.
...
- Palavras com erro linguístico / case sensitive.
- Nenhuma novidade correspondente a pesquisa.
- Má conexão.

## Requisitos não funcionais:

- Função de fácil acesso e visibilidade.
- Busca deve ser o mais rápido possível.
- Exibir “barra” ou algo que demonstre que os dados estão sendo carregados pelo sistema.
